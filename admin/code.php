...
if(isset($_POST['add_category_btn'])){
    ...
    $category_query = "INSERT INTO categories (name,description,status,popular,image) 
    ...
    if($name !="" &&  $description != "") {
        ...
        $product_query = "INSERT INTO products (category_id, name,  small_description, description, selling_price, qty, status, trending, image) 
        VALUES ('$category_id','$name','$small_description','$description','$price','$qty','$status','$trending', '$filename')";
  ...
  $update_query =  "UPDATE `products` SET `category_id`='$category_id',`name`='$name',`small_description`='$small_description',`description`='$description',`selling_price`='$price',
